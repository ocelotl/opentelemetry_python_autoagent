...
setup(
    name='opentelemetry_python_autoagent',
    version=find_version('lib/opentelemetry_python_autoagent/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://opentelemetry_python_autoagent.readthedocs.org/',
    keywords='opentelemetry_python_autoagent',
